...
3. **Structure**:
   ...
   - Verification Steps
4. **Last Phase**: Must include writing a report to `ai-plans/{YYMMDD}__IMPLEMENTATION-REPORT__{name-of-the-plan}.md`
...
3. **Filename**: Use format `{YYMMDD}__IMPLEMENTATION-PLAN__{kebab-case-title}.md` (create directory if needed)
