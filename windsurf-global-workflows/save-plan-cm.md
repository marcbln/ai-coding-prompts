...
## Requirements:
1. **First Line of Plan**: Must be the filename in format: `ai-plans/{YYMMDD}__IMPLEMENTATION_PLAN__{name-of-the-plan}.md`
...
3. **Structure**:
   ...
   - Verification Steps
4. **Last Phase**: Must include writing a report to `ai-plans/{YYMMDD}__IMPLEMENTATION_REPORT__{name-of-the-plan}.md`
